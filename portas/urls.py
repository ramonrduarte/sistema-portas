...
urlpatterns = [
    ...
    path("porta-1p/opcoes-compativeis/",views.carregar_opcoes_compativeis, name="porta_1p_opcoes_compativeis"),

    # Perfis (estrutura)
    path("perfis/", views.lista_perfis, name="lista_perfis"),
    path("perfis/novo/", views.cadastrar_perfil_modal, name="cadastrar_perfil"),
    path("perfis/<int:pk>/editar/", views.editar_perfil_modal, name="editar_perfil"),
    ...
    path("perfis/compativeis-por-acabamento/", views.carregar_compativeis_por_acabamento, name="perfil_compativeis_por_acabamento"),

    # HTMX - apenas lista de vidros ao trocar espessura
    path("perfis/vidros-por-espessura/",views.carregar_vidros_por_espessura, name="perfil_vidros_por_espessura"),
